...
class ResNet50Network(base.NeuralNetwork):
    """ Implementation of ResNet 50 neural network
    ...
    def __init__(self, context, loss, isTraining):
        ...
        self.loss = loss
        # Base init
        super(ResNet50Network, self).__init__(context, isTraining)
    ...
    def createClassifierLayers(self, baseLayers, context):
        ...
        pooling_regions = 14
        input_shape = (numROIs, 14, 14, 1024)
