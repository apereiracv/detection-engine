...
class ResnetSmallNetwork(base.NeuralNetwork):
    """ Modification of Resnet to fit in smaller memory
    """
    ...
    def __init__(self, context, loss, isTraining):
        ...
        self.loss = loss
        # Base init
        super(ResnetSmallNetwork, self).__init__(context, isTraining)
    ...
    def initializeInputs(self, context, isTraining):
        ...
        if isTraining:
            ...
            self.featureMapInput = Input(shape=(None, None, 1024))
    ...
    def initializeModels(self, context, isTraining):
        ...
        optimizerRPN = Adam(lr=1e-4)
        optimizerClassifier = Adam(lr=1e-4)
